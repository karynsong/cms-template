<template>
    <div>
        <div v-for="slevel in _orderBy(baseData, ['order'], 'desc')">
            ...
            <Menu-item :name="flevel.route" v-if="slevel.children.length && flevel.show" v-for="flevel in _orderBy(slevel.children, ['order'])">
